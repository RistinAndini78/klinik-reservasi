  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'admin-dashboard':
        return isAdminLoggedIn ? <AdminDashboard onNavigate={setCurrentPage} onLogout={handleAdminLogout} /> : <AdminLogin onLogin={handleAdminLogin} onNavigate={setCurrentPage} />;
      case 'admin-doctors':
        return isAdminLoggedIn ? <DoctorManagement onNavigate={setCurrentPage} onLogout={handleAdminLogout} /> : <AdminLogin onLogin={handleAdminLogin} onNavigate={setCurrentPage} />;
      case 'admin-services':
